...
#
#     PHX_SERVER=true bin/hotspot_api start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :hotspot_api, HotspotApiWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :hotspot_api, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :hotspot_api, HotspotApi.Mailer,
